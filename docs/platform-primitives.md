...
> See `concepts.md` §Platform Primitives for the conceptual positioning. This document defines the interface capabilities and the per-platform implementations.
